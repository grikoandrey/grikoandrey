![html](https://github.com/user-attachments/assets/00164028-8e4a-4e5a-90c1-4faea830225c)Доброго времени суток, меня зовут Андрей! 👋
...
Languages: ![Uploading html<svg xmlns="http://www.w3.org/2000/svg" width="65" height="20" role="img" aria-label="HTML5"><title>HTML5</title><linearGradient id="s" x2="0" y2="100%"><stop offset="0" stop-color="#bbb" stop-opacity=".1"/><stop offset="1" stop-opacity=".1"/></linearGradient><clipPath id="r"><rect width="65" height="20" rx="3" fill="#fff"/></clipPath><g clip-path="url(#r)"><rect width="0" height="20" fill="#555"/><rect x="0" width="65" height="20" fill="#e34f26"/><rect width="65" height="20" fill="url(#s)"/></g><g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110"><image x="5" y="3" width="14" height="14" href="data:image/svg+xml;base64,"/><text aria-hidden="true" x="415" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="370">HTML5</text><text x="415" y="140" transform="scale(.1)" fill="#fff" textLength="370">HTML5</text></g></svg>.svg…]()
